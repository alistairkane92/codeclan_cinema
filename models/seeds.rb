...
screening1 = Screening.new({"ticket_id" => ticket1.id, "show_time" => "2017-11-12 10:00:00"})
screening1.save()

screening2 = Screening.new({"ticket_id" => ticket2.id, "show_time" => "2017-10-12 09:30:00"})
screening2.save()

screening3 = Screening.new({"ticket_id" => ticket3.id, "show_time" => "2017-12-12 18:45:00"})
screening3.save()

screening4 = Screening.new({"ticket_id" => ticket6.id, "show_time" => "2017-11-12 10:00:00"})
screening4.save()
